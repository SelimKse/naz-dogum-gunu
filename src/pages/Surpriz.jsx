        ...
        {!isRevealed ? (
          ...
          <AnimatePresence>
            ...
            >
              ...
              <motion.div
                className="absolute top-8 right-24 bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold z-50"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.div
                className="absolute top-16 right-24 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-3 py-1 rounded-full text-sm font-bold z-50"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 2 }}
              >
                    ...
                    onClick={async () => {
                      if (feedback.trim().length >= 100) {
                        ...
                        try {
                          ...
                          if (response.ok) {
                            console.log("✅ Feedback MongoDB'ye kaydedildi!");
                          } else {
